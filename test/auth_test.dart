...
void main() {
  group('Mock Authentication', () {
    ...
    test('Cannot log out if not initialized', () async {
      expect(provider.logout(),  throwsA(
    ...
    test('Create user should delegate to login function', () async {
      ...
      final badPasswordUser = provider.createUser(email: 'someone@bar.com',
      password: 'foobar',
      );
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<AuthUser> login(
    ...
    const user = AuthUser(isEmailVerified: false, email: null, id: null);
  ...
  Future<void> sendEmailVerification() async {
    ...
    const newUser = AuthUser(
      isEmailVerified: true, email: null, id: null,
    );
